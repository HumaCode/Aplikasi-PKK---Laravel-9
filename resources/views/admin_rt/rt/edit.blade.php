...
<div class="col-md-12">
    ...
    <div class="card card-cyan card-outline">
        <div class="card-body">
            ...
            <form action="{{ url('admin2/proses-edit-admin/' . $adminRt->username) }}" method="post">
                @method('put')
                @csrf
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kota') is-invalid @enderror" name="kota"
                                id="kota" placeholder="Masukan Kota" value="{{ old('kota', $adminRt->kota) }}">
                            @error('kota')
                            <div class="invalid-feedback">
                                <div class="ml-1">{{ $message }}</div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('provinsi') is-invalid @enderror"
                                ...
                                value="{{ old('provinsi', $adminRt->provinsi) }}">
                            @error('provinsi')
                            <div class="invalid-feedback">
                                <div class="ml-1">{{ $message }}</div>
                            </div>
                ...
                <a href="{{ url('admin2/daftar-admin') }}" class="btn btn-danger"><i class="fas fa-trash"></i>&nbsp;
                    KEMBALI</a>
            </form>
