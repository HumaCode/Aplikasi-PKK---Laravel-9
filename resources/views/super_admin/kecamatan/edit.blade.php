...
<div class="col-md-12">
    ...
    <div class="card card-cyan card-outline">
        <div class="card-body">
            ...
            <form action="{{ url('admin/proses-edit-admin-kecamatan/' . $kecamatan->username) }}" method="post">
                @method('put')
                @csrf
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                                id="nama" placeholder="Masukan Nama" value="{{ old('nama', $kecamatan->nama) }}">
                            @error('nama')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kecamatan') is-invalid @enderror"
                                ...
                                value="{{ old('kecamatan', $kecamatan->kecamatan) }}">
                            @error('kecamatan')
                            <div class="invalid-feedback">
                                <div class="ml-1">{{ $message }}</div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " name="kota" id="kota" placeholder="Masukan Kota"
                                value="{{ old('kota', $kecamatan->kota) }}" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " name="provinsi" id="provinsi"
                                placeholder="Masukan Provinsi" value="{{ old('provinsi', $kecamatan->provinsi) }}"
                                readonly>
